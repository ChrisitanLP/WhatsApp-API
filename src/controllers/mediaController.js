...
class MediaController {
    ...
    sendImage = asyncHandler(async (req, res) => {
        ...
        await this.whatsappService.sendMediaMessage({clientId, tel, mediaPath: imagePath, isGroup, type: 'image'});
    ...
    sendSticker = asyncHandler(async (req, res) => {
        ...
        await this.whatsappService.sendMediaMessage({clientId, tel, mediaPath: stickerPath, isGroup, type: 'sticker'});
    ...
    sendMessageProduct = asyncHandler(async (req, res) => {
        ...
        await this.whatsappService.sendProductMessage({clientId, tel, message: mensaje, image: imagen, isGroup: false});
    ...
    sendMessageProductGroup = asyncHandler(async (req, res) => {
        ...
        await this.whatsappService.sendMessageProductGroup({clientId, groupId: groupId, tel: groupId, message: mensaje, image: imagen, isGroup: true});
